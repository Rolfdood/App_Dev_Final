            ...
            <div class="edit_content">
                ...
                <form action="" method="post">
                    <div class="edit_fields">
                        ...
                        <input type="text" name="edit_item" id="edit_item" <?php if ($err_bud_items[1] == True) echo 'class="err_field"';
                    ...
                    <div class="edit_fields">
                        ...
                        <input type="text" name="edit_purp" id="edit_purp" <?php if ($err_bud_items[2] == True) echo 'class="err_field"';
                    ...
                    <div class="edit_fields">
                        ...
                        <input type="text" name="edit_amnt" id="edit_amnt" <?php if ($err_bud_items[3] == True) echo 'class="err_field"';
