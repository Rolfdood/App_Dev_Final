        ...
        <form method="post" target="_self">
          <div class="row_field_row">
            <div class="row_fields">
              ...
              <input type="text" name="fname" id="fname" class="<?php if(@$error['fname']) echo "err_field"?>" value="<?php echo @$fname?>" required>
              <?php if (@$error['fname']) echo '<span class="err_message">Invalid First Name</span>'; ?>
            </div>

            <div class="row_fields">
              <label for="mname">Middle Name:</label>
              <input type="text" name="mname" id="mname" class="<?php if(@$error['mname']) echo "err_field"?>" value="<?php echo @$mname?>">
              <?php if (@$error['mname']) echo '<span class="err_message">Invalid Middle Name</span>'; ?>
            </div>
            
            <div class="row_fields">
              <label for="lname">Last Name:</label>
              <input type="text" name="lname" id="lname" class="<?php if(@$error['lname']) echo "err_field"?>" value="<?php echo @$lname?>" required>
          ...
          <div class="row_field_row">
            <div class="row_fields">
              ...
              <input type="text" name="uname" id="uname" class="<?php if(@$error['uname']) echo "err_field"?>" value="<?php echo @$uname?>" required>
              <?php if (@$error['uname']) echo '<span class="err_message">Invalid Username</span>'; ?>
            </div>
            
            <div class="row_fields">
              <label for="email">Email:</label>
              <input type="text" name="email" id="email" class="<?php if(@$error['email']) echo "err_field"?>" value="<?php echo @$email?>" required>
          ...
          <div class="row_field_row">
            <div class="row_fields">
              ...
              <input type="password" name="password" id="pass" class="<?php if(@$error['password']) echo "err_field"?>" value="<?php echo @$password?>" required>
              <?php if (@$error['password']) echo '<span class="err_message">Invalid Password</span>'; ?>
            </div>

            <div class="row_fields">
              <label for="check_pass">Confirm Password:</label>
              <input type="password" name="check_password" id="check_pass" class="<?php if(@$error['check_password']) echo "err_field"?>" required>
